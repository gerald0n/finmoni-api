...
export class WorkspacesController {
    ...
    @ApiNotFoundResponse({ description: 'Workspace não encontrado ou sem acesso' })
    ...
    @ApiNotFoundResponse({ description: 'Workspace não encontrado' })
    @ApiForbiddenResponse({ description: 'Apenas o OWNER pode deletar o workspace' })
    ...
    @ApiOperation({
        ...
        description: 'Convida uma pessoa para o workspace via email (OWNER ou ADMIN)'
    })
    @ApiParam({ name: 'id', description: 'ID do workspace' })
    @ApiResponse({
        status: 201,
    ...
    @ApiConflictResponse({ description: 'Usuário já é membro ou já possui convite pendente' })
    ...
    @ApiOperation({
        ...
        description: 'Aceita um convite pendente e adiciona o usuário como membro do workspace'
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiForbiddenResponse({ description: 'Permissão insuficiente' })
    @ApiBadRequestResponse({ description: 'Não é possível remover o último OWNER' })
    updateMemberRole(
        @Param('id') id: string,
    ...
    @ApiBadRequestResponse({ description: 'Último OWNER não pode sair. Transfira a propriedade primeiro.' })
